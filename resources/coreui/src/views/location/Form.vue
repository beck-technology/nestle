                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    <b-form-fieldset label="Address">
                                        <b-form-input type="text" :class="errors.has('address') ? 'form-control is-invalid':'form-control'" v-validate="'required'" name="address" v-model="location.address" placeholder="Enter Address"></b-form-input>
                                    </b-form-fieldset>
                                </div>
                                <div class="form-group col-sm-6">
                                    <b-form-fieldset label="Post Code">
                                        <b-form-input type="text" :class="errors.has('post_code') ? 'form-control is-invalid':'form-control'" v-validate="'required'" name="post_code" v-model="location.post_code" placeholder="Enter Post Code"></b-form-input>
                                    </b-form-fieldset>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    ...
                                    <select class="form-control" :class="errors.has('user_id') ? 'form-control is-invalid':'form-control'" v-validate="'required'" name="user_id" v-model="location.user_id" required>
